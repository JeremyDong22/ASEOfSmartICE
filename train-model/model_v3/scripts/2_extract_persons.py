#!/usr/bin/env python3
# Version: 3.0 (Model V3)
# Extract all persons from screenshot images using YOLO (camera_35 and camera_22 only)
...
# Extraction settings
MIN_PERSON_SIZE = 220  # Minimum pixel size for person detection (optimized for ~5k high-quality images)
