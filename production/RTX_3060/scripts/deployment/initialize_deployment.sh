...
CAMERAS_CONFIG="$SCRIPTS_ROOT/cameras_config.json"
CAMERAS_CONFIG_BACKUP="$SCRIPTS_ROOT/cameras_config.json.backup"
ROI_CONFIG="$SCRIPTS_ROOT/table_region_config.json"
ROI_CONFIG_BACKUP="$SCRIPTS_ROOT/table_region_config.json.backup"
